package com.example.do_an.profile.stats;
...
import androidx.fragment.app.Fragment; // Đã thay thế AppCompatActivity bằng Fragment
...
public class StatisticFragment extends Fragment { // Đã chuyển thành Fragment
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.stats_activity_statistics, container, false);
    }
