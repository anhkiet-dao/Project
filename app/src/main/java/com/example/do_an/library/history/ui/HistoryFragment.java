package com.example.do_an.library.history;
...
import com.example.do_an.core.constants.FirebaseConstants;
import com.example.do_an.library.history.model.HistoryGroup;
import com.example.do_an.library.history.group.HistoryGroupAdapter;
...
//    private Button btnBack;
    ...
    private DatabaseReference buildHistoryRef(String emailKey) {
        return FirebaseDatabase.getInstance(FirebaseConstants.URL)
