...
import com.example.do_an.player.ui.ReadFragment;
...
public class SeriesFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (args != null) {
            storyId = args.getString(StoryBundleConstants.ID, "");
            storyName = args.getString(StoryBundleConstants.NAME, "");
            storyAuthor = args.getString(StoryBundleConstants.AUTHOR, "");
            storyCategory = args.getString(StoryBundleConstants.GENRE, "");
            storyDescription = args.getString(StoryBundleConstants.DESCRIPTION, "");
            storyImageUrl = args.getString(StoryBundleConstants.IMAGE_URL, "");
        } else {
            storyId = "";
            storyName = "";
            storyAuthor = "";
