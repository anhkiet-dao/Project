...
public class ReadlistFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup viewGroup, @Nullable Bundle savedInstanceState) {
        ...
        storyAdapter.setOnStoryClickListener(story -> {
            ...
            args.putString(StoryBundleConstant.STORY_ID, story.getId());
            args.putString(StoryBundleConstant.STORY_NAME, story.getTitle());
            args.putString(StoryBundleConstant.STORY_AUTHOR, story.getAuthor());
            args.putString(StoryBundleConstant.STORY_CATEGORY, story.getGenre());
            args.putString(StoryBundleConstant.STORY_IMAGE_URL, story.getThumbnail());
